...
import 'package:titik_temu/screens/admin/admin_dashboard_screen.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _login() async {
    ...
    // 1. Cek email khusus demo admin kelompok (Bypass Firebase Auth)
    if (email == 'admin@titiktemu.com' && password == 'admin123') {
    ...
    if (success) {
      ...
      // 2. Cek database Firestore role admin atau status blokir
      try {
        ...
        if (uid != null) {
          ...
          if (userDoc.exists) {
            ...
            if (userData?['status'] == 'Diblokir') {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(
                  content: Text('Akun Anda telah ditangguhkan/diblokir oleh administrator.'),
        ...
        // Abaikan error database, lanjutkan ke HomeScreen biasa
      }

...
import 'package:titik_temu/screens/admin/map_location_picker_screen.dart'; // Pastikan path ini sesuai dengan struktur proyek Anda

// Catatan: Sesuaikan folder '/itinerary/map_location_picker_screen.dart'
// dengan letak file map picker asli di proyek Anda jika letaknya berbeda.
...
class _AdminDashboardScreenState extends State<AdminDashboardScreen>
  ...
  void _openMapPicker(
    ...
    final LatLng? result = await Navigator.push<LatLng>(
      ...
      MaterialPageRoute(
        builder: (_) =>
            MapLocationPickerScreen(city: city, initialLocation: initialLoc),
      ),
    );
  ...
  void _showAddEditPlaceDialog({PlaceModel? place}) {
    ...
    final priceController = TextEditingController(
      text: place?.price.toString() ?? '0',
    );
    final latController = TextEditingController(
      text: place?.latitude.toString() ?? '-7.7956',
    );
    final lngController = TextEditingController(
      text: place?.longitude.toString() ?? '110.3695',
    );
                      ...
                      decoration:
                          _buildInputDecoration(
                            ...
                            suffixIcon: IconButton(
                              ...
                              onPressed: () =>
                                  _pickAndUploadImage(imageController, 'place'),
                            ),
                          ),
                    ),
                  ],
                  ...
                  onPressed: () {
                    ...
                    setState(() {
                      if (isEdit) {
                        ...
                        final newId =
                            'yog_${DateTime.now().millisecondsSinceEpoch}';
                        mockPlaces.insert(
                          0,
                          PlaceModel(
                            id: newId,
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        content: Text(
                          isEdit
                              ? 'Berhasil mengedit destinasi!'
                              : 'Berhasil menambah destinasi baru!',
  ...
  void _showAddEditHotelDialog({MockHotelModel? hotel}) {
    ...
    final priceController = TextEditingController(
      text: hotel?.pricePerNight.toString() ?? '500000',
    );
    final ratingController = TextEditingController(
      text: hotel?.rating.toString() ?? '4.5',
    );
    final latController = TextEditingController(
      text: hotel?.latitude.toString() ?? '-7.7956',
    );
    final lngController = TextEditingController(
      text: hotel?.longitude.toString() ?? '110.3695',
    );
    final imageController = TextEditingController(
      text:
          hotel?.imageUrl ??
                      ...
                      decoration:
                          _buildInputDecoration(
                            ...
                            suffixIcon: IconButton(
                              ...
                              tooltip: 'Unggah Gambar dari Perangkat',
                              onPressed: () =>
                                  _pickAndUploadImage(imageController, 'hotel'),
                            ),
                          ),
                    ),
                  ],
                  ...
                  onPressed: () {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        content: Text(
                          isEdit
                              ? 'Berhasil mengedit rekomendasi hotel!'
                              : 'Berhasil menambah hotel baru!',
                          style: const TextStyle(fontFamily: 'Poppins'),
                        ),
                      ),
                    );
  ...
  Widget _buildWisataTab() {
    final filteredPlaces = mockPlaces
        .where((p) => p.city.toLowerCase() == _selectedCity.toLowerCase())
        .toList();
                        ...
                        trailing: Row(
                          ...
                          children: [
                            IconButton(
                              ...
                              onPressed: () =>
                                  _showAddEditPlaceDialog(place: place),
                            ),
                            IconButton(
                              icon: const Icon(
                                Icons.delete,
                              ...
                              onPressed: () {
                                ...
                                ScaffoldMessenger.of(context).showSnackBar(
                                  const SnackBar(
                                    content: Text('Berhasil menghapus wisata'),
                                  ),
                                );
                              },
                            ),
  ...
  Widget _buildHotelTab() {
    final filteredHotels = mockHotels
        .where((h) => h.city.toLowerCase() == _selectedCity.toLowerCase())
        .toList();
                          ...
                          children: [
                            ...
                            IconButton(
                              ...
                              onPressed: () {
                                ...
                                ScaffoldMessenger.of(context).showSnackBar(
                                  const SnackBar(
                                    content: Text('Berhasil menghapus hotel'),
                                  ),
                                );
                              },
                            ),
                    ...
                    : TextButton(
                        ...
                        onPressed: () async {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(
                                'Status user $name diubah menjadi ${isBlocked ? 'Aktif' : 'Diblokir'}',
                              ),
                            ),
                          );
                        },
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: TabBarView(
        controller: _tabController,
        children: [_buildWisataTab(), _buildHotelTab(), _buildUserTab()],
      ),
              ...
              onPressed: () {
                if (_tabController.index == 0) {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(
                      content: Text(
                        'Pendaftaran user baru dapat dilakukan melalui halaman registrasi utama.',
                      ),
                    ),
                  );
                }

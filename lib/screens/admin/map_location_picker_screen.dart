        ...
        title: Column(
          ...
          children: [
            const Text(
              ...
              style: TextStyle(fontWeight: FontWeight.bold, fontFamily: 'Poppins', fontSize: 16, color: Colors.white),
            ),
            Text(
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Column(
                          children: [
                            const Text('LATITUDE', style: TextStyle(fontSize: 10, color: Colors.white60, fontFamily: 'Poppins', fontWeight: FontWeight.bold)),
                            const SizedBox(height: 4),
                            Text(
                              _currentLocation.latitude.toStringAsFixed(6),
                              style: const TextStyle(fontSize: 15, color: Colors.white, fontWeight: FontWeight.bold, fontFamily: 'Poppins'),
                            ),
                          ],
                        ),
                        ...
                        Column(
                          children: [
                            const Text('LONGITUDE', style: TextStyle(fontSize: 10, color: Colors.white60, fontFamily: 'Poppins', fontWeight: FontWeight.bold)),
                            const SizedBox(height: 4),
                            Text(
